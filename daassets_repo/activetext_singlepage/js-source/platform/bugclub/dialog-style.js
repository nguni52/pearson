...
ActiveText.namespace('BugClub.DialogStyleText');
BugClub.DialogStyleText = (function(ActiveText) {
    'use strict';
    ...
    function getStyle(activeTextInstance) {
        ...
        return '.ui-helper-hidden' +
            ...
            'background:transparent url(' + pathToResources + 'img/bugclub/closesmall.svg) top left no-repeat !important;' +
            'border:none;' +
            'margin:-10px;' +
            '}' +
            '.ui-dialog .ui-dialog-titlebar-close.ui-state-hover {' +
            'background:transparent url(' + pathToResources + 'img/bugclub/closesmall-over.svg) top left no-repeat !important;' +
            'border:none;' +
            '}' +
