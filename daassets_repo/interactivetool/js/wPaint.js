...
(function($)
{
	...
	$.fn.wPaint.defaultSettings = {
		...
		menu 				: ['undo','clear','line','pencil','eraser','lineWidth','strokeColor'] // menu items - appear in order they are set
	};
	...
	MainMenu.prototype = 
	{
		generate: function(canvas, textMenu)
		{
			...
			//content
			var menuContent = $('<div class="col-md-12 _wPaint_options"></div>');
			
			$.each($canvas.settings.menu, function(i, item)
			{
				switch(item)
				{
					case 'undo': menuContent.append($('<div class="col-md-1 _wPaint_icon _wPaint_undo" title="undo"></div>').click(function(){ $canvas.undoPrev(); })).append($('<div class="col-md-1 _wPaint_icon _wPaint_redo" title="redo"></div>').click(function(){ $canvas.undoNext(); })); break;
					case 'clear': menuContent.append($('<div class="col-md-1 _wPaint_icon _wPaint_clear" title="clear"></div>').click(function(){ $canvas.clearAll(); })); break;
					case 'rectangle': menuContent.append($('<div class="col-md-1 _wPaint_icon _wPaint_rectangle" title="rectangle"></div>').click(function(){ _self.set_mode(_self, $canvas, 'Rectangle'); })); break;
					case 'ellipse': menuContent.append($('<div class="col-md-1 _wPaint_icon _wPaint_ellipse" title="ellipse"></div>').click(function(){ _self.set_mode(_self, $canvas, 'Ellipse'); })); break;
					case 'line': menuContent.append($('<div class="col-md-1 _wPaint_icon _wPaint_line" title="line"></div>').click(function(){ _self.set_mode(_self, $canvas, 'Line'); })); break;
					case 'pencil': menuContent.append($('<div class="col-md-1 _wPaint_icon _wPaint_pencil" title="pencil"></div>').click(function(){ _self.set_mode(_self, $canvas, 'Pencil'); })); break;
					case 'text': menuContent.append($('<div class="col-md-1 _wPaint_icon _wPaint_text" title="text"></div>').click(function(){ _self.set_mode(_self, $canvas, 'Text'); })); break;
					case 'eraser': menuContent.append($('<div class="col-md-1 _wPaint_icon _wPaint_eraser" title="eraser"></div>').click(function(e){ _self.set_mode(_self, $canvas, 'Eraser'); })); break;
					case 'fillColor': menuContent.append($('<div class="col-md-1 _wPaint_fillColorPicker _wPaint_colorPicker" title="fill color"></div>')); break;
					case 'lineWidth': menuContent.append(lineWidth); break;
					case 'strokeColor': menuContent.append($('<div class="col-md-1 _wPaint_strokeColorPicker _wPaint_colorPicker" title="stroke color"></div>')); break;
			...
			//menu
			return this.menu = 
			$('<div class="container" id="canvas_tools"></div>').append('<div class="row _wPaint_menu"></div>').html(menuContent);
		},
	...
	TextMenu.prototype = 
	{
		generate: function(canvas, mainMenu)
		{
			...
			//content
			var menuContent = 
			$('<div class="col-md-12 _wPaint_options"></div>')
			...
			//menu
			return this.menu = 
			$('<div class="row _wPaint_menu"></div>')
			.append(menuContent);
		},
