	...
	Zoomer.prototype = {
		...
		***********************************************************************************************************************/
		init: function () {
			...
			//Buttons Container		
			$controls = $(
				'<div id="zoomcontrols" style="position: absolute; ' + hProp + ':' + hVal + 'px; ' + vProp + ': ' + vVal + 'px; width: ' + cBW + 'px; height: ' + cBH + 'px; z-index: 160;display: none" class="noSel;"><div id="zoomdata"><a id="zoomdatabutton" class="btn sample btn-xs btn-sample" href="#" onmousedown="writeObject()" onClick="return false">Click to Get Zoom Percentage:</a><span id="code" style="color:#fff"></span></div>\
